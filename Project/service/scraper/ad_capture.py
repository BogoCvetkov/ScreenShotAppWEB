...
class AdCapture:
    ...
    def _construct_capture_flow(self, page_name=None, page_id=None, scrolls=3, country="ALL", keyword="marketing"):
    ...
    def capture_db_pages(self, pages_list, scrolls=3, country="ALL"):
        status = ""
